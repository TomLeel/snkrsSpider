  ...
  saveData(data, that) {
    ...
    data.objects.length &&
      data.objects.forEach(item => {
        ...
        title.search('Release Date') !== -1
          ? (title = title.substr(0, title.length - 12))
          : null
